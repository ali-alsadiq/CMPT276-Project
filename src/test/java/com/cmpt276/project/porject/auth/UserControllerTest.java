...
public class UserControllerTest {
    ...
    public void testLoginSuccessForUser() throws Exception {
        User mockUser = new User("testuser1", "StrongPass1!", "USER");
        List<User> mockList = Collections.singletonList(mockUser);

        Mockito.when(userRepository.findByUsernameAndPassword("testuser1", "StrongPass1!")).thenReturn(mockList);
    ...
    void testLoginSuccessForAdmin() throws Exception {
        User mockUser = new User("testadmin1", "StrongPass1!", "ADMIN");
        List<User> mockList = Collections.singletonList(mockUser);
