...
public class MealControllerTest {
    ...
    // GET /calorie-tracker returns progress circle model attributes if session is valid
    @Test
    ...
    // POST /calorie-tracker/search returns empty list if no session
    @Test
    ...
    // POST /calorie-tracker/search sanitizes decimals in description before searching
    @Test
    public void search_decimalInDescription_sanitizesBeforeSearch() throws Exception {
    ...
    // POST /meals/add redirect to login if no session
    @Test
    ...
    // POST /meals/add saves meal and redirects to calorie-tracker on valid submission
    @Test
